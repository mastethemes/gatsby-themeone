...
const Projects = ({ children, offset }) => (
  <>
    ...
    <Divider speed={0.1} offset={offset} factor={2}>
      <UpDown>
        <SVG icon="box" width={6}  left="85%" top="75%" />
        <SVG icon="upDown" width={8}  left="70%" top="20%" />
        <SVG icon="triangle" width={8}  left="25%" top="5%" />
        <SVG icon="circle" hiddenMobile width={24}  left="17%" top="60%" />
      </UpDown>
      <UpDownWide>
        <SVG icon="arrowUp" hiddenMobile width={16}  left="20%" top="90%" />
        <SVG icon="triangle" width={12}  left="90%" top="30%" />
        <SVG icon="circle" width={16}  left="70%" top="90%" />
        <SVG icon="triangle" hiddenMobile width={16}  left="18%" top="75%" />
      ...
      <SVG icon="circle" width={12}  left="80%" top="60%" />
      <SVG icon="box" width={6}  left="10%" top="10%" />
      <SVG icon="box" width={12}  left="29%" top="26%" />
      <SVG icon="hexa" width={16}  left="75%" top="30%" />
